...
import * as Ledger from './v9Ledger.js';
import * as Runtime from './v9Runtime.js';
...
/** An executable form of a Compact compiled contract, bound to ledger 9. */
...
/**
 * Takes a Compact compiled contract, and makes it executable against ledger 9.
 *
