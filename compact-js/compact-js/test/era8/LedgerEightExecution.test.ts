...
describeWithFixture('ledger 8 era execution', () => {
  ...
  it('runs a circuit and records a public transcript', async () => {
    ...
    // The 0.16 signature: contract address FIRST and no circuit id, against 0.19's
    // `(circuitId, address, …)`. This positional difference is half of what the adapter absorbs.
