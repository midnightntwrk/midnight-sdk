...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.private_increment) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named private_increment');
    }
  ...
  _private_increment_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.private_increment(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(Array.isArray(result_0) && result_0.length === 0 )) {
      __compactRuntime.typeError('private_increment',
                                 'return value',
  ...
  _increment_0(context, partialProofData) {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 1 } }]);
    this._private_increment_0(context, partialProofData);
    return [];
  }
...
const _dummyContract = new Contract({
  private_increment: (...args) => undefined
});
