...
import { CompiledContract, type Contract, ContractRuntimeError } from '@midnightntwrk/compact-js/effect';
import * as Hex from '@midnightntwrk/platform-js/effect/Hex'
