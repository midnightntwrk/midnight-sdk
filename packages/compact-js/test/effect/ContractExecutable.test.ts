...
import {
  CompiledContract,
  Contract,
  ContractExecutable} from '@midnightntwrk/compact-js/effect';
import * as ContractConfigurationError from '@midnightntwrk/compact-js/effect/ContractConfigurationError';
import { ZKFileConfiguration } from '@midnightntwrk/compact-js-node/effect';
import {
  ContractDeploy,
...
import * as Configuration from '@midnightntwrk/platform-js/effect/Configuration';
import * as ContractAddress from '@midnightntwrk/platform-js/effect/ContractAddress';
