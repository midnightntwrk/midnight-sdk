 ...
 * @category services
 */
export class Keys extends Context.Tag('@midnightntwrk/platform-js/Configuration#Keys')<
  Keys,
  Configuration.Keys
>() {}
 ...
 * @category services
 */
export class Network extends Context.Tag('@midnightntwrk/platform-js/Configuration#Network')<
  Network,
  NetworkId.NetworkId
>() {}
