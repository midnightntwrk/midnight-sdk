...
_Vendored from [ojowwalker77/Claude-Matrix](https://github.com/ojowwalker77/Claude-Matrix/tree/main/skills/effect-ts) (MIT). Frontmatter was adapted for standalone Claude Code use. See `ATTRIBUTION.md`._
